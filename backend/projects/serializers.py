...
from .workflow_presentation import get_project_workflow_summary
...
class ProjectRequestListSerializer(serializers.ModelSerializer):
    ...
    def get_workflow(self, obj):
        return get_project_workflow_summary(obj)
...
class ProjectRequestDetailSerializer(ProjectRequestListSerializer):
    ...
    def get_time_remaining_hours(self, obj):
        """Return remaining hours or None."""
...
class DirectEditorProposalCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        transition_project_request(
            project_request=project_request,
            to_status=ProjectRequest.Status.EDITOR_SELECTED,
            actor=editor_profile.user,
        )
...
class DirectEditorDeclineSerializer(serializers.Serializer):
    ...
    def save(self, **kwargs):
        ...
        transition_project_request(
            project_request=project_request,
            to_status=ProjectRequest.Status.CANCELLED,
            actor=editor_profile.user,
        )
...
class SelectProjectProposalSerializer(serializers.Serializer):
    ...
    def save(self, **kwargs):
        ...
        transition_project_request(
            ...
            extra_updates={"target_editor": proposal.editor},
        )
...
class ConvertProjectRequestToOrderSerializer(serializers.Serializer):
    ...
    @transaction.atomic
    def save(self, **kwargs):
        from orders.models import Order, OrderActivityLog, OrderImage
        from orders.workflow import record_initial_order_status
        ...
        transition_project_request(
            ...
            actor=request.user,
            extra_updates={"converted_order": order},
        )
...
class ManagedAssignProjectRequestSerializer(serializers.Serializer):
    ...
    def save(self, **kwargs):
        ...
        extra_updates = {"target_editor": editor_profile}
        if support_note:
            extra_updates["support_note"] = support_note
